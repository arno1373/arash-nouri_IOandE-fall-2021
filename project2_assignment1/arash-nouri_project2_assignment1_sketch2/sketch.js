...
// This sketch interfaces with X/Y/Z values from the built-in accelerometer on the Sensorkit
// The 3 co-ordinates manipulate the size of the ellipses & the frequency of oscillations
...
function draw() {
  ...
  text('X / Y / Z Values: ' + latestData, 40, 60);
