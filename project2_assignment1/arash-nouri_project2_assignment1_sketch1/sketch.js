...
// This sketch interfaces with analog sensor inputs from Arduino
// The analog inputs (potentiometer, light sensor, sound sensor) manipulate the size of the ellipses & the frequency of oscillations
...
// Size of each individual ellipse has been modified to match the others and not exceed a certain size depending on analog values
...
function draw() {
  ...
  text('Light sensor / potentiometer / sound sensor values: ' + latestData, 40, 60);
  ...
  ellipse(windowWidth / 2, windowHeight / 2, diameter1/4, diameter1/4);
  ellipseMode(RADIUS);
